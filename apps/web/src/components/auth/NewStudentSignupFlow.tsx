    ...
    <div className="rise-card p-7 lg:p-8">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <h2 className="mt-2 text-[2.1rem] font-black leading-none text-[#1d1830]">
            {isTutorPath ? 'Finish your account' : 'Build your maths setup'}
          </h2>
          <p className="mt-3 max-w-xl text-sm font-medium leading-relaxed text-[#6f6a84]">
            {isTutorPath
        ...
        <div className="rounded-[1rem] border border-[#eadff7] bg-[#fbf8ff] px-4 py-3 text-right">
      ...
      <form action={signup} className="mt-6 space-y-6">
          ...
          <div className="space-y-5">
            <div className="rounded-[1.15rem] border border-[#ebe2f8] bg-[#fbf9ff] p-4">
              ...
              <div className="mt-3 grid gap-3 sm:grid-cols-2">
                ...
                <SummaryItem
                  label="Track"
                  value={isTutorPath ? initialValues.recommendedTopic || 'Tutor-curated maths path' : 'Open maths onboarding'}
                />
              </div>
            </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-t border-[#f0e9fb] pt-5">
